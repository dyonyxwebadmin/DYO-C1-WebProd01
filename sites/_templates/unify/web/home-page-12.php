...
<html lang="en">
  <head>
    <!-- Title -->
    <title>Home Page 12 | Unify - Responsive Website Template</title>
    ...
    <main>
      ...
      <section class="g-pos-rel">
        ...
        <div class="js-carousel"
             ...
             data-fade="true"
             data-speed="5000">
          <div class="js-slide g-min-height-100vh g-flex-centered g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after" style="background-image: url(/img/temp/1920x1080/img20.jpg);"></div>

          <div class="js-slide g-min-height-100vh g-flex-centered g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after" style="background-image: url(/img/temp/1920x1080/img17.jpg);"></div>
        </div>
        ...
        <div class="g-absolute-centered--y g-left-0 g-right-0">
          <div class="container g-z-index-1">
            ...
            <div class="input-group g-max-width-400 g-rounded-50">
              ...
              <span class="input-group-addon u-shadow-v19 g-brd-none g-bg-white">
                <button class="btn u-btn-primary g-width-40 g-height-40 rounded-circle g-pa-0" type="submit">
          ...
          <article class="row">
            ...
            <div class="col-lg-6 g-mb-30">
              ...
              <div class="g-pl-90--sm">
                ...
                <div class="d-flex">
                  <!-- Video Bock -->
                  <div class="u-shadow-v21 g-bg-img-hero g-pos-rel g-height-160 g-width-300 rounded" style="background-image: url('/img/temp/400x270/img1.jpg');"
                       data-bg-img-src="/img/temp/400x270/img1.jpg">
                    <a class="js-fancybox-media g-absolute-centered" href="//vimeo.com/167434033"
            ...
            <div class="col-lg-6 align-self-center">
              <img class="img-fluid w-100 u-shadow-v21 rounded" src="/img/temp/900x600/img3.jpg" alt="Iamge Description">
            </div>
            <!-- End Article Image -->
          </article>
        </div>
      ...
      <section class="text-center">
        <!-- Testimonials -->
        <div class="row align-items-stretch no-gutters g-bg-black-opacity-0_9 g-min-height-80vh" style="background-image: url('/img/bg/pattern3.png');">
          <div class="col-lg-6 g-bg-img-hero g-min-height-400" style="background-image: url('/img/temp/900x900/img3.jpg');"></div>

          <div class="col-lg-6 align-self-center g-pa-100">
            <img class="g-width-70 g-height-70 g-brd-3 g-brd-style-solid g-brd-white rounded-circle g-mb-30" src="/img/temp/100x100/img5.jpg" alt="Image Description">
      ...
      <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll">
        <!-- Parallax Image -->
        <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-repeat g-bg-white-gradient-opacity-v1--after" style="height: 160%; background-image: url(/img/bg/pattern3.png);"></div>
        <!-- End Parallax Image -->
      ...
      <section class="text-center g-py-100">
        <div class="container">
          ...
          <div class="g-bg-img-hero g-pb-70" style="background-image: url(/img/maps/map3.png);">
            <div class="row justify-content-center g-pt-100--md">
              ...
              <div class="col-md-6 col-lg-4 hidden-sm-down g-bg-size-cover g-min-height-300 g-pos-rel rounded g-top-minus-70 g-ml-minus-50" data-bg-img-src="/img/temp/900x900/img2.jpg"></div>
            </div>
          </div>
      ...
      <!-- Call To Action -->
      <section class="g-bg-primary g-color-white g-pa-40" style="background-image: url(/img/bg/pattern5.png);">
        <div class="container u-bg-overlay__inner">
          <div class="row">
            ...
            <div class="col-md-4 align-self-center">
              <div class="input-group g-brd-white--focus rounded">
