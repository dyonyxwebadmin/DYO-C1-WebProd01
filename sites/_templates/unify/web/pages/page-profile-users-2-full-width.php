...
<html lang="en">
  ...
  <body>
              ...
              <div class="g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-30">
                <div class="row">
                  <div class="col-lg-3 text-center g-mb-40 g-mb-0--lg">
                    <!-- User Image -->
                    <div class="g-mb-20">
                      <img class="img-fluid" src="/img/temp/400x450/img1.jpg" alt="Image Description">
                    </div>
                    <!-- User Image -->
                  ...
                  <div class="col-lg-9">
                    ...
                    <div class="lead g-line-height-1_8">
                      <p>About elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla lectus tellusimp imperdiet molestie est. Dell viverra cursus nibh volutpat at. This is where we sit down, grab a cup of coffee and dial in the details. Understanding the task at hand and ironing out the wrinkles is key.</p>
                    ...
                    <div class="d-flex flex-wrap text-center">
                      ...
                      <div class="g-mr-40 g-mb-20 g-mb-0--xl">
                        <div class="js-pie g-color-purple g-mb-5"
                      ...
                      <!-- Counter Pie Chart -->
                      <div class="g-mr-40 g-mb-20 g-mb-0--xl">
                        <div class="js-pie g-color-blue g-mb-5"
                      ...
                      <!-- Counter Pie Chart -->
                      <div class="g-mr-40 g-mb-20 g-mb-0--xl">
                        <div class="js-pie g-color-lightred g-mb-5"
                      ...
                      <!-- Counter Pie Chart -->
                      <div class="g-mr-40 g-mb-20 g-mb-0--xl">
                        <div class="js-pie g-color-primary g-mb-5"
              ...
              <div class="g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-30">
                <div class="row">
                  <div class="col-lg-3 text-center g-mb-40 g-mb-0--lg">
                    <!-- User Image -->
                    <div class="g-mb-20">
                      <img class="img-fluid" src="/img/temp/400x450/img6.jpg" alt="Image Description">
                    </div>
                    <!-- User Image -->
              ...
              <div class="g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-40">
                <div class="row">
                  <div class="col-lg-3 text-center g-mb-40 g-mb-0--lg">
                    <!-- User Image -->
                    <div class="g-mb-20">
                      <img class="img-fluid" src="/img/temp/400x450/img2.jpg" alt="Image Description">
                    </div>
                    <!-- User Image -->
    ...
    <script src="/js/vendor/circles/circles.min.js"></script>
