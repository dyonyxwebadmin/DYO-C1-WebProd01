...
<html lang="en">
  ...
  <body>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 g-mb-50 g-mb-0--lg">
              ...
              <div class="list-group list-group-border-0 g-mb-40">
                ...
                <!-- Settings -->
                <a href="page-profile-settings-1" class="list-group-item justify-content-between active">
                    ...
                    <div class="form-group row g-mb-25">
                      ...
                      <div class="col-sm-9">
                        <label class="form-check-inline u-check mx-0">
                          <input class="hidden-xs-up g-pos-abs g-top-0 g-right-0" name="savePassword" type="checkbox">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <label class="u-check w-100 g-mb-25">
                          ...
                          <input class="hidden-xs-up g-pos-abs g-top-10 g-right-10" type="radio" name="profilePayments" checked="">
                          ...
                          <div class="g-brd-primary--checked g-bg-primary-opacity-0_2--checked g-brd-around g-brd-gray-light-v2 g-rounded-5">
                            <div class="media g-pa-12">
                              ...
                              <div class="d-flex align-self-center g-width-20 g-ml-15">
                                <div class="u-check-icon-radio-v5 g-pos-rel g-width-20 g-height-20"><i></i></div>
                              </div>
                            </div>
                          </div>
                        </label>
                      ...
                      <div class="col-md-3">
                        <label class="u-check w-100 g-mb-25">
                          ...
                          <input class="hidden-xs-up g-pos-abs g-top-10 g-right-10" type="radio" name="profilePayments">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group g-mb-20">
                          ...
                          <div class="input-group g-brd-primary--focus">
                            <input id="inputGroup1_3" class="form-control form-control-md g-brd-right-none rounded-0 g-py-13" type="text"
                  ...
                  <form>
                    ...
                    <div class="form-group">
                      <label class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="u-check">
                          <input class="hidden-xs-up g-pos-abs g-top-0 g-right-0" name="emailNotification" type="checkbox" checked>
                          <div class="u-check-icon-radio-v7">
                            <i class="d-inline-block"></i>
                          </div>
                        </div>
                    ...
                    <div class="form-group">
                      <label class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="u-check">
                          <input class="hidden-xs-up g-pos-abs g-top-0 g-right-0" name="commentNotification" type="checkbox">
                          <div class="u-check-icon-radio-v7">
                            <i class="d-inline-block"></i>
                          </div>
                        </div>
                    ...
                    <div class="form-group">
                      <label class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="u-check">
                          <input class="hidden-xs-up g-pos-abs g-top-0 g-right-0" name="updateNotification" type="checkbox" checked>
                          <div class="u-check-icon-radio-v7">
                            <i class="d-inline-block"></i>
                          </div>
                        </div>
                    ...
                    <div class="form-group">
                      <label class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="u-check">
                          <input class="hidden-xs-up g-pos-abs g-top-0 g-right-0" name="messageNotification" type="checkbox" checked>
                          <div class="u-check-icon-radio-v7">
                            <i class="d-inline-block"></i>
                          </div>
                        </div>
                    ...
                    <div class="form-group">
                      <label class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="u-check">
                          <input class="hidden-xs-up g-pos-abs g-top-0 g-right-0" name="newsletterNotification" type="checkbox">
                          <div class="u-check-icon-radio-v7">
                            <i class="d-inline-block"></i>
                          </div>
                        </div>
    ...
    <script src="/js/vendor/jquery.maskedinput/src/jquery.maskedinput.js"></script>
    ...
    <script src="/js/helpers/hs.not-empty-state.js"></script>
