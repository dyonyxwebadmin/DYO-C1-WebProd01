...
<html lang="en">
  ...
  <body>
    <main>
      <!-- Signup -->
      <section class="g-min-height-100vh g-flex-centered g-bg-img-hero g-bg-pos-top-center" style="background-image: url(/img/temp/1920x1080/img2.jpg);">
            ...
            <div class="col-sm-10 col-md-9 col-lg-6">
              <div class="g-bg-white rounded g-py-40 g-px-30">
                ...
                <footer class="text-center">
                  <p class="g-color-gray-dark-v5 g-font-size-13 mb-0">Already have an account? <a class="g-font-weight-600" href="page-signup7">signin</a></p>
                </footer>
              </div>
            </div>
          </div>
