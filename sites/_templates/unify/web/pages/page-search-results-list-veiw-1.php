  ...
  <body>
    <main>
      ...
      <section class="dzsparallaxer auto-init height-is-based-on-content use-loading" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
        <!-- Parallax Image -->
        <div class="divimage dzsparallaxer--target w-100 g-bg-cover g-bg-white-gradient-opacity-v3--after" style="height: 140%; background-image: url(/img/temp/1920x800/img10.jpg);"></div>
        <!-- End Parallax Image -->
        ...
        <div class="container">
          ...
          <article>
            <header class="g-mb-15">
              ...
              <span class="g-color-primary">https://wrapbootstrap.com/theme/unify-responsive-website-template-WB0412697</span>
            </header>

            <p class="g-mb-15">Nullam elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla lectus tellusimp imperdiet molestie est volutpat at, sed viverra cursus nibh. At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores.</p>

            <div class="d-lg-flex justify-content-between align-items-center">
              <!-- Search Info -->
              <ul class="list-inline g-mb-10 g-mb-0--lg">
                <li class="list-inline-item g-mr-30">
                  <img class="g-height-25 g-width-25 rounded-circle g-mr-5" src="/img/temp/100x100/img7.jpg" alt="Image Description"> <a class="u-link-v5 g-color-main g-color-primary--hover" href="#">John Doe</a>
                </li>
                <li class="list-inline-item g-mr-30">
          ...
          <article>
            ...
            <p class="g-mb-15">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores. Nullam elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla lectus tellusimp imperdiet molestie est volutpat at, sed viverra cursus nibh.</p>

            <div class="d-lg-flex justify-content-between align-items-center">
              <ul class="list-inline g-mb-10 g-mb-0--lg">
                <li class="list-inline-item g-mr-30">
                  <img class="g-height-25 g-width-25 rounded-circle g-mr-5" src="/img/temp/100x100/img1.jpg" alt="Image Description"> <a class="u-link-v5 g-color-main g-color-primary--hover" href="#">Htmlstream</a>
                </li>
                <li class="list-inline-item g-mr-30">
          ...
          <article>
            ...
            <div class="d-lg-flex justify-content-between align-items-center">
              <ul class="list-inline g-mb-10 g-mb-0--lg">
                <li class="list-inline-item g-mr-30">
                  <img class="g-height-25 g-width-25 rounded-circle g-mr-5" src="/img/temp/100x100/img5.jpg" alt="Image Description"> <a class="u-link-v5 g-color-main g-color-primary--hover" href="#">Sally Manning</a>
                </li>
                <li class="list-inline-item g-mr-30">
          ...
          <article>
            ...
            <div class="d-lg-flex justify-content-between align-items-center">
              <ul class="list-inline g-mb-10 g-mb-0--lg">
                <li class="list-inline-item g-mr-30">
                  <img class="g-height-25 g-width-25 rounded-circle g-mr-5" src="/img/temp/100x100/img17.jpg" alt="Image Description"> <a class="u-link-v5 g-color-main g-color-primary--hover" href="#">David Miller</a>
                </li>
                <li class="list-inline-item g-mr-30">
          ...
          <article>
            ...
            <div class="d-lg-flex justify-content-between align-items-center">
              <ul class="list-inline g-mb-10 g-mb-0--lg">
                <li class="list-inline-item g-mr-30">
                  <img class="g-height-25 g-width-25 rounded-circle g-mr-5" src="/img/temp/100x100/img3.jpg" alt="Image Description"> <a class="u-link-v5 g-color-main g-color-primary--hover" href="#">Pixeel</a>
                </li>
                <li class="list-inline-item g-mr-30">
