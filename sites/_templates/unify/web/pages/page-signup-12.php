...
<html lang="en">
  ...
  <body>
        ...
        <div class="row">
          <div class="col-lg-5 flex-lg-unordered g-mb-80">
            ...
            <div class="text-center">
              <p class="g-color-gray-dark-v5 mb-0">Already have an account? <a class="g-font-weight-600" href="page-login-12">signin</a></p>
            </div>
          </div>
          ...
          <div class="col-lg-7 flex-lg-first g-mb-80">
            <div class="g-pr-20--lg">
              ...
              <div class="text-center">
                ...
                <img class="img-fluid" src="/img/maps/map1.png" alt="Image Description">
              </div>
            </div>
          </div>
        </div>
    ...
    <script src="/js/vendor/image-select/src/ImageSelect.jquery.js"></script>
