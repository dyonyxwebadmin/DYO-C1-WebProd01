...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/js/vendor/malihu-scrollbar/jquery.mCustomScrollbar.min.css">
  ...
  <body>
    <main>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 g-mb-50 g-mb-0--lg">
              ...
              <div class="u-block-hover g-pos-rel">
                <figure>
                  <img class="img-fluid w-100 u-block-hover__main--zoom-v1" src="/img/temp/400x450/img5.jpg" alt="Image Description">
                </figure>
              ...
              <div class="list-group list-group-border-0 g-mb-40">
                <!-- Overall -->
                <a href="page-profile-main-1" class="list-group-item list-group-item-action justify-content-between">
                ...
                <!-- Profile -->
                <a href="page-profile-profile-1" class="list-group-item list-group-item-action justify-content-between">
                  <span><i class="icon-cursor g-pos-rel g-top-1 g-mr-8"></i> Profile</span>
                </a>
                <!-- End Profile -->

                <!-- Users Contacts -->
                <a href="page-profile-users-1" class="list-group-item list-group-item-action justify-content-between">
                  <span><i class="icon-notebook g-pos-rel g-top-1 g-mr-8"></i> Users Contacts</span>
                </a>
                <!-- End Users Contacts -->

                <!-- My Projects -->
                <a href="page-profile-projects-1" class="list-group-item justify-content-between active">
                ...
                <!-- Comments -->
                <a href="page-profile-comments-1" class="list-group-item list-group-item-action justify-content-between">
                ...
                <!-- Reviews -->
                <a href="page-profile-reviews-1" class="list-group-item list-group-item-action justify-content-between">
                  <span><i class="icon-heart g-pos-rel g-top-1 g-mr-8"></i> Reviews</span>
                </a>
                <!-- End Reviews -->

                <!-- History -->
                <a href="page-profile-history-1" class="list-group-item list-group-item-action justify-content-between">
                  <span><i class="icon-fire g-pos-rel g-top-1 g-mr-8"></i> History</span>
                </a>
                <!-- End History -->

                <!-- Settings -->
                <a href="page-profile-settings-1" class="list-group-item list-group-item-action justify-content-between">
                  ...
                  <ul class="list-unstyled">
                    <li class="media g-brd-around g-brd-gray-light-v4 g-brd-left-3 g-brd-blue-left rounded g-pa-20 g-mb-10">
                      <div class="d-flex g-mt-2 g-mr-15">
                        <img class="g-width-40 g-height-40 rounded-circle" src="/img/temp/100x100/img1.jpg" alt="Image Description">
                      </div>
                    ...
                    <li class="media g-brd-around g-brd-gray-light-v4 g-brd-left-3 g-brd-black-left rounded g-pa-20 g-mb-10">
                      <div class="d-flex g-mt-2 g-mr-15">
                        <img class="g-width-40 g-height-40 rounded-circle" src="/img/temp/100x100/img4.jpg" alt="Image Description">
                      </div>
                      <div class="media-body">
                        <div class="d-flex justify-content-between">
                  ...
                  <ul class="list-unstyled">
                      ...
                      <div class="d-flex justify-content-between">
                        <ul class="u-list-inline">
                          <li class="list-inline-item mr-0">
                            <img class="g-brd-around g-brd-gray-light-v3 g-pa-2 g-width-40 g-height-40 rounded" src="/img/temp/100x100/img1.jpg" alt="Image Description">
                          </li>
                          <li class="list-inline-item mr-0">
                            <img class="g-brd-around g-brd-gray-light-v3 g-pa-2 g-width-40 g-height-40 rounded" src="/img/temp/100x100/img5.jpg" alt="Image Description">
                          </li>
                          <li class="list-inline-item mr-0">
                            <img class="g-brd-around g-brd-gray-light-v3 g-pa-2 g-width-40 g-height-40 rounded" src="/img/temp/100x100/img2.jpg" alt="Image Description">
                          </li>
                          <li class="list-inline-item mr-0">
                            <img class="g-brd-around g-brd-gray-light-v3 g-pa-2 g-width-40 g-height-40 rounded" src="/img/temp/100x100/img6.jpg" alt="Image Description">
                          </li>
                          <li class="list-inline-item mr-0">
                    ...
                    <li class="g-brd-around g-brd-gray-light-v4 g-brd-left-3 g-brd-pink-left rounded g-pa-20 g-mb-10">
                      ...
                      <div class="d-flex justify-content-between">
                        <ul class="u-list-inline">
                          <li class="list-inline-item mr-0">
                            <img class="g-brd-around g-brd-gray-light-v3 g-pa-2 g-width-40 g-height-40 rounded" src="/img/temp/100x100/img8.jpg" alt="Image Description">
                          </li>
                          <li class="list-inline-item mr-0">
                            <img class="g-brd-around g-brd-gray-light-v3 g-pa-2 g-width-40 g-height-40 rounded" src="/img/temp/100x100/img3.jpg" alt="Image Description">
                          </li>
                          <li class="list-inline-item mr-0">
                            <img class="g-brd-around g-brd-gray-light-v3 g-pa-2 g-width-40 g-height-40 rounded" src="/img/temp/100x100/img11.jpg" alt="Image Description">
                          </li>
                          <li class="list-inline-item mr-0">
                            <img class="g-brd-around g-brd-gray-light-v3 g-pa-2 g-width-40 g-height-40 rounded" src="/img/temp/100x100/img4.jpg" alt="Image Description">
                          </li>
                          <li class="list-inline-item mr-0">
                    ...
                    <li class="g-brd-around g-brd-gray-light-v4 g-brd-left-3 g-brd-primary-left rounded g-pa-20 g-mb-10">
                      ...
                      <div class="d-flex justify-content-between">
                        <ul class="u-list-inline">
                          ...
                          <li class="list-inline-item mr-0">
                            <img class="g-brd-around g-brd-gray-light-v3 g-pa-2 g-width-40 g-height-40 rounded" src="/img/temp/100x100/img12.jpg" alt="Image Description">
                          </li>
                          <li class="list-inline-item mr-0">
                            <img class="g-brd-around g-brd-gray-light-v3 g-pa-2 g-width-40 g-height-40 rounded" src="/img/temp/100x100/img3.jpg" alt="Image Description">
                          </li>
                      ...
                      <tbody>
                        <tr>
                          <td class="align-middle text-nowrap text-center">
                            <img class="g-brd-around g-brd-gray-light-v4 g-pa-2 g-width-50 g-height-50 rounded-circle" src="/img/temp/100x100/img3.jpg" data-toggle="tooltip" data-placement="top" data-original-title="Pixeel Ltd" alt="Image Description">
                          </td>
                        ...
                        <tr>
                          <td class="align-middle text-nowrap text-center">
                            <img class="g-brd-around g-brd-gray-light-v4 g-pa-2 g-width-50 g-height-50 rounded-circle" src="/img/temp/100x100/img1.jpg" data-toggle="tooltip" data-placement="top" data-original-title="Htmlstream" alt="Image Description">
                          </td>
                        ...
                        <tr>
                          <td class="align-middle text-nowrap text-center">
                            <img class="g-brd-around g-brd-gray-light-v4 g-pa-2 g-width-50 g-height-50 rounded-circle" src="/img/temp/100x100/img4.jpg" data-toggle="tooltip" data-placement="top" data-original-title="Starbucks" alt="Image Description">
                          </td>
                        ...
                        <tr>
                          <td class="align-middle text-nowrap text-center">
                            <img class="g-brd-around g-brd-gray-light-v4 g-pa-2 g-width-50 g-height-50 rounded-circle" src="/img/temp/100x100/img2.jpg" data-toggle="tooltip" data-placement="top" data-original-title="Wrapbootstrap" alt="Image Description">
                          </td>
                        ...
                        <tr>
                          <td class="align-middle text-nowrap text-center">
                            <img class="g-brd-around g-brd-gray-light-v4 g-pa-2 g-width-50 g-height-50 rounded-circle" src="/img/temp/100x100/img5.jpg" data-toggle="tooltip" data-placement="top" data-original-title="Pinterest" alt="Image Description">
                          </td>
      ...
      <!-- Footer -->
      <section class="g-bg-black-opacity-0_9 g-color-white-opacity-0_8 g-py-60">
        <div class="container">
          <div class="row">
            <!-- Footer Content -->
    ...
    <script src="/js/vendor/malihu-scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
