...
<div id="sb-site">
        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div id="page-title">
                            <h2><?php cms("PageTitle", "IoT READINESS ASSESSMENT TOOL", true, 250); ?></h2>
                            <p><?php cms("PageDesc", "Assess your readiness to expand and grow your IoT practice by getting an assessment score", true, 120); ?></p>
                        </div>
                    </div>
                                    ...
                                    <div class="tab-pane pad0A fade active in" id="tab-start">
                                            ...
                                            <div class="content-box mrg15B">
                                                ...
                                                <form class="form-horizontal pad15L pad15R bordered-row" id="form-assessment-profile" data-parsley-validate="">
                                                    ...
                                                    <div class="form-group remove-border">
                                                        <label class="col-sm-3 control-label"><?php cms("PartnerID", "Partner ID", true, 250); ?>:</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" data-assessment-external-id="external_id" class="form-control" id="external_id" required placeholder="Enter your ID...">
                                                        </div>
                                                    </div>
                                                    <div class="form-group remove-border">
                                    ...
                                    <div class="panel-content pad15A bg-white">
                                        <div class="center-vertical">
                                            ...
                                            <ul class="center-content list-group list-group-separator row mrg0A">
                                                <li class="col-md-6">
                                                    <a href="/tools/assessments" title="">
                                                        <i class="glyph-icon icon-typicons-vcard"></i>
                                                        <p class="mrg5T">Start a New Assessment</p>
                                                    </a>
                                                </li>
                                                <li class="col-md-6">
                                                    <a href="/tools/assessments/list" title="">
                                                        <i class="glyph-icon icon-list-alt"></i>
                                                        <p class="mrg5T">View All Assessments</p>
                                                    </a>
                                                </li>
                                            </ul>

                                        </div>
                                        <div class="pad45A bg-white text-left">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            assessment_id = location.pathname.split("/")[3];
