                ...
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <div class="example-box-wrapper">
                            <table id="datatable-offers" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            </table>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function() {
            ...
            var table = $('#datatable-offers').DataTable( {
                ...
                "columns": [
                    ...
                    { "title": "Goal", "data": "lead_goal", "className":"link" },
                    { "title": "Started On", "data": "start_date", "className":"link" }
                ]
            } );
            ...
            $('#datatable-offers tbody').on('click', 'tr', function () {
                    var data = table.row( this ).data();
                    window.location.replace('/admin/companies/details?' + data['id']);
                });
