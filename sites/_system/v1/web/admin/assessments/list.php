    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var table = $('#datatable-users').DataTable( {
                "ajax": {
                    "url": "/api/assessments/assessment.list.all",
                    "dataSrc": ""
                },
                "columns": [
                    { "title": "Level", "data": "level", "className":"link" },
                    { "title": "Score", "data": "score", "className":"link" },
                    { "title": "Avnet Org ID", "data": "external_id", "className":"link" },
                    { "title": "Partner", "data": "company_name", "className":"link" },
            ...
            $('#datatable-users tbody').on('click', 'tr', function () {
                    ...
                    window.location.replace('/admin/assessments/view/' + data['id']);
                });
