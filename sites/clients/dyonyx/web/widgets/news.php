          ...
          <div class="row">
            <div class="col-lg-4 g-mb-30">
              ...
              <article class="u-shadow-v21 g-bg-white rounded">
                ...
                <div class="media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-pa-15-30">
                  <img class="d-flex g-width-20 g-height-20 rounded-circle g-mr-10" src="/img/temp/100x100/img5.jpg" alt="Image Description">
            ...
            <div class="col-lg-4 g-mb-30">
              ...
              <article class="u-shadow-v21 g-bg-white rounded">
                ...
                <div class="media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-pa-15-30">
                  <img class="d-flex g-width-20 g-height-20 rounded-circle g-mr-10" src="/img/temp/100x100/img14.jpg" alt="Image Description">
                  <div class="media-body align-self-center">
            ...
            <div class="col-lg-4 g-mb-30">
              ...
              <article class="u-shadow-v21 g-bg-white rounded">
                ...
                <div class="media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-pa-15-30">
                  <img class="d-flex g-width-20 g-height-20 rounded-circle g-mr-10" src="/img/temp/100x100/img17.jpg" alt="Image Description">
                  <div class="media-body align-self-center">
