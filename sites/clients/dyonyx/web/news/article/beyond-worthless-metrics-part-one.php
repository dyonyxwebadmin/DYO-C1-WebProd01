    ...
    <main>
      ...
      <section class="container g-pt-100 g-pb-60">
        <div class="row justify-content-center">
          <div class="col-lg-9">
            <div class="g-mb-60">
              <h1 class="g-color-black g-font-weight-600 text-center g-mb-30">Beyond Worthless Metrics…<br />Adding Value to the Information Security Program</h1>
            </div>
...
<h4>What caused such abysmal failures in readiness?</h4>
...
<h4>What does that information MEAN?</h4>
...
<h4>Action Items:</h4>
<ul>
  <li>Between time constraints and in some cases, failures in communication, what should organizations who find themselves in this position do?</li>
  <li>Transition towards automated solutions for managing necessary paper trails. Automation also allows you to measure and “things that are measured, get done.”</li>
  <li>Improve communication through better knowledge of the environment and consolidating views of security metrics</li>
  <li>Move towards a more agile threat response paradigm – improve data capabilities using tools which allow for a better understanding of the IT environment</li>
</ul>

<br />

<a class="g-font-size-13" href="/news/article/beyond-worthless-metrics-part-two">Continue Reading Part 2</a>
